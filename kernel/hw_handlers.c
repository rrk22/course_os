...
long __attribute__((interrupt("SWI"))) software_interrupt_handler(void)
{
	...
	case SYSCALL_CREATE_THREAD:
		os_printf("Create Thread system call called\n");
		return (long) k_thread_creates(r0, (kthread_callback_handler) r1, r2);
	case SYSCALL_THREAD_EXIT:
		os_printf("Exit Thread System call called\n");
		return 0L;
	case SYSCALL_GET_ID:
		os_printf("Get ID system call called\n");
		return 0L;
